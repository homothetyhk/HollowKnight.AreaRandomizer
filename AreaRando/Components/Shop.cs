...
namespace AreaRando.Components
{
    internal class Shop : MonoBehaviour
    {
        ...
        static Shop()
        {
            bottomFrames = new[]
            {
                AreaRando.GetSprite("Anim.Shop.BottomFleur.2"),
                AreaRando.GetSprite("Anim.Shop.BottomFleur.3"),
                AreaRando.GetSprite("Anim.Shop.BottomFleur.4"),
                AreaRando.GetSprite("Anim.Shop.BottomFleur.5"),
                AreaRando.GetSprite("Anim.Shop.BottomFleur.6"),
                AreaRando.GetSprite("Anim.Shop.BottomFleur.7"),
                AreaRando.GetSprite("Anim.Shop.BottomFleur.8")
            };

            topFrames = new[]
            {
                AreaRando.GetSprite("Anim.Shop.TopFleur.0"),
                AreaRando.GetSprite("Anim.Shop.TopFleur.1"),
                AreaRando.GetSprite("Anim.Shop.TopFleur.2"),
                AreaRando.GetSprite("Anim.Shop.TopFleur.3"),
                AreaRando.GetSprite("Anim.Shop.TopFleur.4"),
                AreaRando.GetSprite("Anim.Shop.TopFleur.5"),
                AreaRando.GetSprite("Anim.Shop.TopFleur.6"),
                AreaRando.GetSprite("Anim.Shop.TopFleur.7"),
                AreaRando.GetSprite("Anim.Shop.TopFleur.8")
            };
        }
        ...
        public void Start()
        {
            geoSprite = type == ShopType.Geo
                ? AreaRando.GetSprite("UI.Shop.Geo")
                : AreaRando.GetSprite("UI.Shop.Essence");
        ...
        private bool IsValid(ShopItemDef item)
        {
            ...
            if (AreaRando.GetSprite(item.SpriteName) == null)
            {
                return false;
            }
        ...
        private void BuildItemImages()
        {
            ...
            for (int i = 0; i < itemImages.GetLength(0); i++)
            {
                itemImages[i, 0] = CanvasUtil.CreateImagePanel(gameObject,
                    AreaRando.GetSprite(items[validItems[i]].SpriteName),
        ...
        private IEnumerator ShowShop()
        {
            GameObject background = CanvasUtil.CreateImagePanel(gameObject,
                AreaRando.GetSprite("UI.Shop.Background"),
            ...
            GameObject bottomFleur = CanvasUtil.CreateImagePanel(gameObject,
                AreaRando.GetSprite("Anim.Shop.BottomFleur.0"),
            ...
            CanvasUtil.CreateImagePanel(gameObject, AreaRando.GetSprite("UI.Shop.Selector"),
                new CanvasUtil.RectData(new Vector2(340, 113), Vector2.zero, new Vector2(0.57f, 0.5825f),
                    new Vector2(0.57f, 0.5825f)));
            CanvasUtil.CreateImagePanel(gameObject, AreaRando.GetSprite("UI.Shop.Shitpost"),
