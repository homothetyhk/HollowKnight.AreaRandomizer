...
namespace AreaRando.Components
{
    internal class BigItemPopup : MonoBehaviour
    {
        ...
        static BigItemPopup()
        {
            Frames = new[]
            {
                AreaRando.GetSprite("Anim.BigItemFleur.0"),
                AreaRando.GetSprite("Anim.BigItemFleur.1"),
                AreaRando.GetSprite("Anim.BigItemFleur.2"),
                AreaRando.GetSprite("Anim.BigItemFleur.3"),
                AreaRando.GetSprite("Anim.BigItemFleur.4"),
                AreaRando.GetSprite("Anim.BigItemFleur.5"),
                AreaRando.GetSprite("Anim.BigItemFleur.6"),
                AreaRando.GetSprite("Anim.BigItemFleur.7"),
                AreaRando.GetSprite("Anim.BigItemFleur.8")
            };
        }
            ...
            string descOneKey, string descTwoKey, GameObject fsmObj = null, string eventName = null)
        {
            ...
            popup._imagePrompt = AreaRando.GetSprite(spriteKey);
